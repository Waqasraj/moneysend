...
import moneylink.wallet.adapters.PrepaidOperatorAdapter;
...
public class WRBillerOperatorsDialog extends BaseDialogFragment<TransferDialogPurposeBinding>
    ...
    List<PrepaidOperatorResponse> billerTypeResponseList;
    OnPrepaidCountry onWRBillerNames;
    PrepaidOperatorAdapter adapter;


    public WRBillerOperatorsDialog(List<PrepaidOperatorResponse> billerTypeResponseList,
                                   OnPrepaidCountry onWRBillerNames) {
    ...
    private void setupRecyclerView() {
        ...
        adapter = new
                PrepaidOperatorAdapter(getContext(), billerTypeResponseList, this);
    ...
    public void onPrepaidOperator(PrepaidOperatorResponse prepaidOperatorResponse) {
        onWRBillerNames.onPrepaidOperator(prepaidOperatorResponse);
        cancelUpload();
    }
}
